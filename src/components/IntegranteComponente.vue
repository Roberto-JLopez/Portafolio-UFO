...
const educacion = ref([
  ...
  {Integrante: 'Herrera Valentin', title: 'Curso de Desarrollo Web Full Stack (JavaScript, React, Node.js)', descripcion: 'Trabajé en XYZ Tech, donde diseñé y desarrollé aplicaciones web completas utilizando tecnologías como Node.js, React y MongoDB.', enlace:'https://portafolio-valentin-herrera.netlify.app/'},
  {Integrante: 'Fachinotti Pablo', title: 'Especialización en Inteligencia Artificial y Machine Learning (Python, TensorFlow)', descripcion: 'Realicé una pasantía en ABC Solutions, contribuyendo en la creación de interfaces de usuario y optimización de sitios web.', enlace:'https://portafolio-fachinottipablo.netlify.app/'},
  {Integrante: 'Gomez Jose', title: 'Especialización en Inteligencia Artificial y Machine Learning (Python, TensorFlow)', descripcion: 'Centrado en la creación de modelos de machine learning con Python y TensorFlow, abordando temas como redes neuronales y aprendizaje profundo, y cómo aplicarlos en problemas reales como reconocimiento de imágenes y procesamiento de texto.', enlace:'https://portafolio-jose-gomez.netlify.app/'},
  {Integrante: 'Lopez Roberto', title: 'Certificación en Ciencia de Datos (Python, SQL, visualización de datos)', descripcion: 'Enfocado en el análisis y la visualización de datos usando Python y SQL. Roberto aprendería a manejar grandes volúmenes de datos, interpretar resultados y crear gráficos con herramientas como Pandas y Matplotlib.', enlace:'https://portafoliolopezrobertojose.netlify.app/'},
  ...
  {Integrante: 'Nuñez Gimena', title: 'Curso de Desarrollo de Aplicaciones Móviles (Flutter, Android, iOS)', descripcion: 'Completé un curso en línea sobre fundamentos de programación, donde aprendí lenguajes como Python y Java.', enlace:'https://portafolionunezgallardogimena.netlify.app/'}
]);
</script>
